...
#Eltárolja a az előző eredményt
...
kifejez_field.grid(columnspan=4,pady=8 )
	...
	# jelek is itt vannak 
button1 = Button(root, text=' 1 ', fg='black', bg='gray', 
					command=lambda: press(1), height=3, width=7) 
button1.grid(row=2, column=0) 

button2 = Button(root, text=' 2 ', fg='black', bg='gray', 
					command=lambda: press(2), height=3, width=7) 
button2.grid(row=2, column=1) 

button3 = Button(root, text=' 3 ', fg='black', bg='gray', 
					command=lambda: press(3), height=3, width=7) 
button3.grid(row=2, column=2) 

button4 = Button(root, text=' 4 ', fg='black', bg='gray', 
					command=lambda: press(4), height=3, width=7) 
button4.grid(row=3, column=0) 

button5 = Button(root, text=' 5 ', fg='black', bg='gray', 
					command=lambda: press(5), height=3, width=7) 
button5.grid(row=3, column=1) 

button6 = Button(root, text=' 6 ', fg='black', bg='gray', 
					command=lambda: press(6), height=3, width=7) 
button6.grid(row=3, column=2) 

button7 = Button(root, text=' 7 ', fg='black', bg='gray', 
					command=lambda: press(7), height=3, width=7) 
button7.grid(row=4, column=0) 

button8 = Button(root, text=' 8 ', fg='black', bg='gray', 
					command=lambda: press(8), height=3, width=7) 
button8.grid(row=4, column=1) 

button9 = Button(root, text=' 9 ', fg='black', bg='gray', 
...
minus = Button(root, text=' - ', fg='black', bg='gray', 
				command=lambda: press("-"), height=3, width=7) 
minus.grid(row=3, column=3) 

multiply = Button(root, text=' * ', fg='black', bg='gray', 
					command=lambda: press("*"), height=3, width=7) 
multiply.grid(row=4, column=3) 

divide = Button(root, text=' / ', fg='black', bg='gray', 
					command=lambda: press("/"), height=3, width=7) 
divide.grid(row=5, column=3) 

Ans = Button(root, text='Ans', fg='black', bg='gray',
			        command=lambda: press(elozores), height=3, width=7)
